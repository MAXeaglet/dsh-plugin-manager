...
import { listProfiles, listPlugins, setPluginDisabled, setBundle, setBundleOrder, exportProfile, installPlugin, profileDir, profilesDir, dshStatus, startDsh, stopDsh, setPluginConfig, searchNpm, updatePlugin, checkUpdates } from "./profiles.mjs";
